...
<html lang="en">
 ...
 <div class="container">
    ...
    <!-- POP-UP CONTAINER -->
<!-- NOTE: The Receipt Details codes below are just based on the previous "booking-receipt" page. Just modified some of its content. -->
<div class="popup-container" id="popupContainer">
    ...
    <script>
      ...
      function cancelUpcoming(booking_id) {
        ...
        <h3>Confirm Rejection of Request</h3>
        <p>Are you sure you want to reject this request?</p>
        <form method="POST" action="">
        <input type ="hidden" name="variable" id="variable" value="${booking_id}"> 
        <button id="cancel" name="cancel" onclick="confirmCancellation(${booking_id})">Yes, Reject</button>
        </form>
        <button style="background-color: #4CAF50; color: white;" onclick="closePopup()">No, Go Back</button>
        `;
      ...
      function confirmCancellation(booking_id) {
        ...
        alert(
          "Request rejected! For more details, an email will be sent to the user"
        );
    ...
    function approveBooking(booking_id) {
      // Add your code here for approving the booking
      alert("Request approved! For more details, an email will be sent to the user");
      closePopup(); // Code to close the pop-up after approval
    }

    document.getElementById("approveButton").addEventListener("click", function () {
      // You may need to pass the necessary parameters to approveBooking function
      approveBooking(/* Pass the necessary parameters */);
    });
</script>
    </script>
  </body>
