document.addEventListener("DOMContentLoaded", function () {
  ...
  editButton.addEventListener("click", function () {
    if (!isEditing) {
      ...
      this.innerText = "Edit Trips";
      addRowButton.style.display = "none";
      isEditing = false;
      updateLastEditDate();

      // Make added rows non-editable after saving
      document
        .querySelectorAll("#editableTable tbody tr.added-row td")
        .forEach((cell) => {
          cell.contentEditable = false;
        });
    }
  ...
  addRowButton.addEventListener("click", function () {
    ...
    newRow.innerHTML =
      "<td contenteditable='true'></td><td contenteditable='true'></td><td contenteditable='true'></td><td contenteditable='true'></td><td contenteditable='true'></td><td contenteditable='true'></td><td contenteditable='true'></td>";
    document
...
var ref = new Firebase("https://feedback-bts-2-default-rtdb.firebaseio.com/");
